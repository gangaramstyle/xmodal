...
class TrainConfig:
    ...
    v5_slab_random: bool = False      # slab-source: draw slabs at independent random positions (no cube grouping) — ablates the cube constraint
    git_commit: str = ""
    git_branch: str = ""
...
def train_v5(model, train_bundles, val_bundles, specs, cfg: TrainConfig, *, device="cuda", log=print):
    ...
    def draw(bundles, prism_choices=None, prism_patch=None):
        return S.sample_v5_batch(bundles, batch_size=cfg.batch_size, n_src=cfg.v5_n_src, n_anchor=cfg.v5_n_anchor,
                                 ...
                                 slab_random=cfg.v5_slab_random)
